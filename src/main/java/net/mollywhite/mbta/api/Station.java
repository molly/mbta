...
public enum Station {
  ...
  DAVIS ("Davis", Pattern.compile("davis[^\\w]"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.ASHMONT, Branch.BRAINTREE)),
  PORTER ("Porter", Pattern.compile("porter[^\\w]"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.ASHMONT, Branch.BRAINTREE)),
  ...
  KENDALLMIT ("Kendall/MIT", Pattern.compile("(kendall|[^\\w]mit[^\\w])"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.ASHMONT, Branch.BRAINTREE)),
  CHARLESMGH ("Charles/MGH", Pattern.compile("(charles|[^\\w]mgh[^\\w])"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.ASHMONT, Branch.BRAINTREE)),
  PARKST ("Park Street", Pattern.compile("[^\\w]park[^\\w]"), Sets.newHashSet(Line.RED, Line.GREEN), Sets.newHashSet(Branch.B, Branch.C, Branch.D, Branch.E, Branch.ASHMONT, Branch.BRAINTREE)),
  ...
  ANDREW ("Andrew", Pattern.compile("[^\\w]andrew[^\\w]"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.ASHMONT, Branch.BRAINTREE)),
  ...
  FIELDSCORNER ("Fields Corner", Pattern.compile("[^\\w]fields[^\\w]"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.ASHMONT)),
  ...
  CEDARGROVE ("Cedar Grove", Pattern.compile("[^\\w]cedar[^\\w]"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.MATTAPAN)),
  BUTLER ("Butler", Pattern.compile("[^\\w]butler[^\\w]"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.MATTAPAN)),
  MILTON ("Milton", Pattern.compile("[^\\w]milton[^\\w]"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.MATTAPAN)),
  ...
  CAPENST ("Capen Street", Pattern.compile(" capen[^\\w]"), Sets.newHashSet(Line.RED), Sets.newHashSet(Branch.MATTAPAN)),
  ...
  STATE ("State", Pattern.compile("[^\\w]state[^\\w]"), Sets.newHashSet(Line.ORANGE, Line.BLUE), Collections.<Branch>emptySet()),
  ...
  JACKSONSQ ("Jackson Square", Pattern.compile("[^\\w]jackson"), Sets.newHashSet(Line.ORANGE), Collections.<Branch>emptySet()),
  STONYBROOK ("Stony Brook", Pattern.compile("[^\\w]stony"), Sets.newHashSet(Line.ORANGE), Collections.<Branch>emptySet()),
  ...
  AIRPORT ("Airport", Pattern.compile("airport st"), Sets.newHashSet(Line.BLUE), Collections.<Branch>emptySet()),
  ...
  PRUDENTIAL ("Prudential", Pattern.compile("pru(dential)?[^\\w]"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.E)),
  ...
  ELIOT ("Eliot", Pattern.compile("[^\\w]eliot"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.D)),
  ...
  STMARYSST ("St. Marys Street", Pattern.compile("[^\\w]s(t\\.?|aint)[^\\w]mary"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.C)),
  HAWESST ("Hawes Street", Pattern.compile("[^\\w]hawes[^\\w]"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.C)),
  KENTST ("Kent Street", Pattern.compile("[^\\w]kent[^\\w]"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.C)),
  STPAULSTC ("St. Paul Street", Pattern.compile("[^\\w]s(t\\.?|aint)[^\\w]paul"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.C)),
  COOLIDGECORNER ("Coolidge Corner", Pattern.compile("coolidge"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.C)),
  SUMMITAVE ("Summit Avenue", Pattern.compile("[^\\w]summit"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.C)),
  ...
  DEANRD ("Dean Road", Pattern.compile("[^\\w]dean[^\\w]"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.C)),
  ...
  BUEAST ("Boston University East", Pattern.compile("[^\\w](bu|b\\.u\\.|boston univ(ersity)?)[^\\w] e"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.B)),
  BUCENTRAL ("Boston University Central", Pattern.compile("[^\\w](bu|b\\.u\\.|boston univ(ersity)?)[^\\w] cent"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.B)),
  BUWEST ("Boston University West", Pattern.compile("[^\\w](bu|b\\.u\\.|boston univ(ersity)?)[^\\w] w"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.B)),
  STPAULSTB ("St. Paul Street", Pattern.compile("[^\\w]s(t\\.?|aint)[^\\w]paul"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.B)),
  ...
  WARRENST ("Warren Street", Pattern.compile("[^\\w]warren[^\\w]"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.B)),
  ...
  SOUTHST ("South Street", Pattern.compile("[^\\w]south st"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.B)),
  BOSTONCOLLEGE ("Boston College", Pattern.compile("([^\\w]bc[^\\w]|boston college)"), Sets.newHashSet(Line.GREEN), Sets.newHashSet(Branch.B));
